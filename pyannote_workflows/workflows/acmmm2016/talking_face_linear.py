...
class TalkingFaceLinear(sciluigi.WorkflowTask):
    ...
    linearBICClustering__max_gap = luigi.FloatParameter(default=3600.)
    ...
    def workflow(self):
        ...
        # =====================================================================
        # TAG (LINEAR) SPEECH CLUSTERS WITH MOST COOCURRING TALKING-FACE CLUSTER
        # =====================================================================
        ...
        argmaxTagging.in_source = _talkingFaceClustering.out_put
